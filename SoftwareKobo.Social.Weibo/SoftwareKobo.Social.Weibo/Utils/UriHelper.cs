...
namespace SoftwareKobo.Social.Weibo.Utils
{
    ...
    {
        internal static Uri AddOrUpdateQuery(this Uri uri, string parameterName, string parameterValue)
        {
        ...
        internal static Uri AddOrUpdateQuery(this Uri uri, IEnumerable<KeyValuePair<string, string>> parameter)
        {
        ...
        internal static string GetQueryParameter(this Uri uri, string parameterName)
        {
            string query = uri.Query;
            if (query.Length <= 1)
            {
